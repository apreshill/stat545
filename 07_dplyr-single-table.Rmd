...
* dplyr is a core package in the [tidyverse][1] meta-package. Since we often make incidental usage of the others, we will load dplyr and the others via `library(tidyverse)`.
...
Hmmmm ... those GDP numbers are almost uselessly large and abstract. Consider the [advice of Randall Munroe of xkcd][2]:
...
When I first cleaned this Gapminder excerpt, I was a [`camelCase`][3] person, but now I'm all about [`snake_case`][wiki-snake-case]. So I am vexed by the variable names I chose when I cleaned this data years ago. Let's rename some variables!
...
* You can also do very general computations on your groups with `do()`, though elsewhere in this course, I advocate for other approaches that I find more intuitive, using the [purrr package][4].
...
[1]: https://github.com/hadley/tidyverse
[2]: https://fivethirtyeight.com/features/xkcd-randall-munroe-qanda-what-if/
[3]: https://en.wikipedia.org/wiki/Camel_case
[4]: https://purrr.tidyverse.org
[5]: https://tinyurl.com/athenaforehead
