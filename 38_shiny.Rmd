...
* [shinythemes] - Easily alter the appearance of your app ([CRAN](https://CRAN.R-project.org/package=shinythemes)).
* [shinyjs] - Enhance user experience in Shiny apps using JavaScript functions without knowing JavaScript ([CRAN](https://CRAN.R-project.org/package=shinyjs); [GitHub](https://github.com/daattali/shinyjs)).
* [leaflet] - Add interactive maps to your apps ([CRAN](https://CRAN.R-project.org/package=leaflet); [GitHub](https://github.com/rstudio/leaflet)).
* [ggvis] - Similar to ggplot2, but the plots are focused on being web-based and are more interactive ([CRAN](https://CRAN.R-project.org/package=ggvis)).
* [shinydashboard] - Gives you tools to create visual “dashboards” ([CRAN](https://CRAN.R-project.org/package=shinydashboard); [GitHub]((https://github.com/rstudio/shinydashboard))).
...
- [Shiny official website][shiny]
- Official [Learn Shiny tutorial]
...
- [Shiny in R Markdown](https://rmarkdown.rstudio.com/authoring_shiny.html)
...
- [Learn about useful debugging techniques](https://shiny.rstudio.com/articles/debugging.html)
...
This tutorial should take approximately an hour to complete. If you want even more practice, another great tutorial is the official [Learn Shiny tutorial]. RStudio also provides a handy [Shiny cheatsheet] to remember all the little details after you already learned the basics.
...
Hosting your app on [shinyapps.io] is the easy and recommended way of getting your app online.  Go to <https://www.shinyapps.io> and sign up for an account. When you're ready to publish your app, click on the "Publish Application" button in RStudio and follow the instructions. You might be asked to install a couple packages if it's your first time.
...
[Learn Shiny tutorial]: https://shiny.rstudio.com/tutorial/
[Shiny cheatsheet]: https://shiny.rstudio.com/images/shiny-cheatsheet.pdf
[shinyapps.io]: https://www.shinyapps.io
[shiny-server-setup]: https://deanattali.com/2015/05/09/setup-rstudio-shiny-server-digital-ocean/
[shiny-reactivity]: https://shiny.rstudio.com/articles/understanding-reactivity.html
["Building Shiny Apps" slides]: https://docs.google.com/presentation/d/1dXhqqsD7dPOOdcC5Y7RW--dEU7UfU52qlb0YD3kKeLw/edit#slide=id.p
