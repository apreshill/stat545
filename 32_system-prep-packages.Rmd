...
*We've never had this section but [RStudio's devtools guide](https://www.rstudio.com/products/rpackages/devtools/) and the [System Setup](https://r-pkgs.org/setup.html) chapter of [R Packages] both say the `r-devel` or `r-base-dev` package is required. What gives?*
