...
In the [Graphs][cookbook-for-r-multigraphs] chapter of his [Cookbook for R][cookbook-for-r], Winston Chang uses the grid package to define the `multiplot()` function:
...
The cowplot package ([CRAN](https://CRAN.R-project.org/package=cowplot); [GitHub](https://github.com/wilkelab/cowplot)) does (at least) two things:
