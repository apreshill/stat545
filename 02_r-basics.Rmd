...
FYI: you can change the default location of the panes, among many other things: [Customizing RStudio][1].
...
RStudio offers many handy [keyboard shortcuts][2]. Also, Alt+Shift+K brings up a keyboard shortcut reference card.
...
Keeping all the files associated with a project organized together -- input data, R scripts, analytical results, figures -- is such a wise and common practice that RStudio has built-in support for this via its [_projects_][4].
...
[1]: https://support.rstudio.com/hc/en-us/articles/200549016-Customizing-RStudio
[2]: https://support.rstudio.com/hc/en-us/articles/200711853-Keyboard-Shortcuts
[3]: https://support.rstudio.com/hc/en-us/articles/200526217-Command-History
[4]: https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects
