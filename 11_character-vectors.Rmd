...
* The [glue] package is fantastic for string interpolation. If `stringr::str_interp()` doesn't get your job done, check out glue.
...
* We again prefer the [stringr package](https://CRAN.R-project.org/package=stringr) over base functions. Why?
  - Wraps [stringi](https://CRAN.R-project.org/package=stringi), which is a great place to look if stringr isn't powerful enough.
