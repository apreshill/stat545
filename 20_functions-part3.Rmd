...
The [testthat] package ([CRAN][testthat-cran]; [GitHub][testthat-github]) provides excellent facilities for this, with a distinct emphasis on automated unit testing of entire packages. However, we can take it out for a test drive even with our one measly function.
...
* Unit testing with [testthat]
  + On [CRAN][testthat-cran], development on [GitHub][testthat-github]
* Wickham and Bryan's [R Packages] book [-@wickham-unpub]
  + [Testing chapter][r-pkgs2-tests]
