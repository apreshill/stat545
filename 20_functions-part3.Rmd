...
You will also encounter the `...` argument in many built-in functions -- read up on [`c()`][rdocs-c] or [`list()`](https://rdrr.io/r/base/list.html) -- and now you have a better sense of what it means. It is not a breezy "and so on and so forth."
