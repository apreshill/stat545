...
We will work with some of the data from the [Gapminder project][1]. I've released this as an [R package][2], so we can install it from CRAN like so:
...
[2]: https://CRAN.R-project.org/package=gapminder
