...
We will work with some of the data from the [Gapminder project](https://www.gapminder.org). I've released this as an [R package](https://CRAN.R-project.org/package=gapminder), so we can install it from CRAN like so:
