...
[Dates and times](https://r4ds.had.co.nz/dates-and-times.html) chapter from [R for Data Science] by Hadley Wickham and Garrett Grolemund [-@wickham2016]. See also the subsection on dates and times in the [Data import chapter][r4ds-data-import].

The [lubridate] package ([CRAN](https://CRAN.R-project.org/package=lubridate); [GitHub](https://github.com/tidyverse/lubridate); [main vignette](https://cran.r-project.org/web/packages/lubridate/vignettes/lubridate.html)).
