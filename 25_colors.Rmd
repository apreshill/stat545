...
This figure in Wickham's [ggplot2: Elegant Graphics for Data Analysis][ggplot2-book] [-@wickham2009] book is helpful for understanding the HCL color space:


```{r echo = FALSE, fig.cap = "From [ggplot2: Elegant Graphics for Data Analysis][ggplot2-book] by Hadley Wickham [-@wickham2009]"}
...
The dichromat package ([on CRAN](https://CRAN.R-project.org/package=dichromat)) will help you select a color scheme that will be effective for color blind readers.
...
* [Vignette](https://cran.r-project.org/web/packages/colorspace/vignettes/hcl-colors.pdf) for the [colorspace](https://CRAN.R-project.org/package=colorspace) package.
...
* Wickham's [ggplot2: Elegant Graphics for Data Analysis](https://www.springer.com/gp/book/9780387981413) [-@wickham2009].
  + [Online docs (nice!)](https://docs.ggplot2.org/current/)
  + [Package webpage][ggplot2-web]
  + ggplot2 on [CRAN](https://CRAN.R-project.org/package=ggplot2) and [GitHub](https://github.com/tidyverse/ggplot2)
