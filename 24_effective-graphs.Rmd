...
[ggplot2][ggplot2-web] written by [Hadley Wickham](https://hadley.github.io).  

[Winston Chang's](https://github.com/wch) book ["R Graphics Cookbook"](http://shop.oreilly.com/product/0636920023135.do) [-@chang2013] and the [Graphs section](http://www.cookbook-r.com/Graphs/) of his [Cookbook for R website][cookbook-for-r].  
