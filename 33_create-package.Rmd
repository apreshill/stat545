...
This section closely tracks with content from the book [R Packages] by Hadley Wickham and Jenny Bryan [-@wickham-unpub], specifically the [The Whole Game][r-pkgs-whole-game] chapter. The material in this chapter is, however, accurate and up-to-date, although a bit longer than [The Whole Game][r-pkgs-whole-game]. The [R Packages] book is a great place to go next to learn more. 
...
For presentation purposes only, we use the [tidyverse], for light data wrangling, and [fs][fs-web], for filesystem work.
...
[r-pkgs-whole-game]: https://r-pkgs.org/whole-game.html
