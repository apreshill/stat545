...
The official R Markdown documentation is [here](https://rmarkdown.rstudio.com).
...
* You've already [installed Git](https://happygitwithr.com/install-git.html) and (probably) [a Git client](https://happygitwithr.com/git-client.html).
* You've already [registered a free GitHub account](https://happygitwithr.com/github-acct.html).
* You've already [installed R and RStudio](https://happygitwithr.com/install-r-rstudio.html).
...
I am modelling "walk before you run" here. It is best, especially for novices, to increase complexity in small increments. We will test our system's ability to render the ["hello world"](https://en.wikipedia.org/wiki/%22Hello,_world!%22_program) of R Markdown documents before we muddy the waters with our own, probably buggy, documents.
