...
The official R Markdown documentation is [here][1].
...
* You've already [installed Git][2] and (probably) [a Git client][3].
* You've already [registered a free GitHub account][4].
* You've already [installed R and RStudio][5].
* You've [tested your installation and configuration of Git, GitHub, and RStudio][6].
...
Git people: we assume you are working inside a Git repo -- probably one that is already set up to push/pull with a GitHub remote. That is [covered elsewhere][6].

## Step 2: Practice with RStudio's boilerplate R Markdown document

I am modelling "walk before you run" here. It is best, especially for novices, to increase complexity in small increments. We will test our system's ability to render the ["hello world"][7] of R Markdown documents before we muddy the waters with our own, probably buggy, documents.
...
__Don't try to change working directory within an R Markdown document__. [Just don't][11]. That is all.
...
[2]: https://happygitwithr.com/install-git.html
[3]: https://happygitwithr.com/git-client.html
[4]: https://happygitwithr.com/github-acct.html
[5]: https://happygitwithr.com/install-r-rstudio.html
[6]: https://happygitwithr.com/connect-intro.html
[7]: https://en.wikipedia.org/wiki/%22Hello,_world!%22_program
[8]: https://pages.github.com
[9]: https://happygitwithr.com/workflows-browsability.html
[10]: https://support.rstudio.com/hc/en-us/articles/204463668-Code-Snippets
[11]: https://yihui.name/knitr/faq/
