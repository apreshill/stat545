...
The Gapminder data is too clean and simple to show off the great features of readr, so I encourage you to check out the part of the introduction vignette on [column types][3]. There are many variable types that you will be able to parse correctly upon import, thereby eliminating a great deal of post-import fussing.
...
So what do I do? I must admit I save (and re-load) R-specific binary files. Right after I save the plain text file. [Belt and suspenders][5].

I have toyed with the idea of writing import helper functions for a specific project, that would re-order factor levels in principled ways. They could be defined in one file and called from many. This would also have a very natural implementation within [a workflow where each analytical project is an R package][6]. But so far it has seemed too much like [yak shaving][7]. I'm intrigued by a recent discussion of putting such information in YAML frontmatter (see Martin Fenner blog post [Using YAML frontmatter with CSV][8]).
...
Huh? Don't worry about it. Remember we are ["writing data for computers"][4]. The partner function `dget()` reads this representation back in.
...
The main application of this is [the creation of highly portable, self-contained minimal examples][9]. For example, if you want to pose a question on a forum or directly to an expert, it might be required or just plain courteous to NOT attach any data files. You will need a monolithic, plain text blob that defines any necessary objects and has the necessary code. `dput()` can be helpful for producing the piece of code that defines the object. If you `dput()` without specifying a file, you can copy the return value from Console and paste into a script. Or you can write to file and copy from there or add R commands below.
...
[Data import][r4ds-data-import] chapter of [R for Data Science][r4ds] by Hadley Wickham and Garrett Grolemund [-@wickham2016].

White et al.'s "Nine simple ways to make it easier to (re)use your data" [-@white2013]. 

* First appeared [in PeerJ Preprints][10]
* Published in [Ideas in Ecology and Evolution in 2013][11]
...
* Available as a PDF [here][12]

Data Manipulation in R by Phil Spector [-@spector2008].

* Available via [SpringerLink][13]
* [Author's webpage][14]
* [GoogleBooks search][15]
* See Chapter 2 ("Reading and Writing Data")


[1]: https://kbroman.org/minimal_make/
[2]: https://readr.tidyverse.org
[3]: https://cran.r-project.org/web/packages/readr/vignettes/readr.html
[4]: https://twitter.com/vsbuffalo/statuses/358699162679787521
[5]: https://www.wisegeek.com/what-does-it-mean-to-wear-belt-and-suspenders.html
[6]: https://www.carlboettiger.info/2012/05/06/research-workflow.html
[7]: https://seths.blog/2005/03/dont_shave_that/
[8]: https://blog.datacite.org/using-yaml-frontmatter-with-csv/
[9]: https://stackoverflow.com/questions/5963269/how-to-make-a-great-r-reproducible-example
[10]: https://doi.org/10.7287/peerj.preprints.7v2
[11]: https://ojs.library.queensu.ca/index.php/IEE/article/view/4608
[12]: http://vita.had.co.nz/papers/tidy-data.pdf
[13]: https://www.springer.com/gp/book/9780387747309
[14]: https://www.stat.berkeley.edu/%7Espector/
[15]: https://books.google.com/books?id=grfuq1twFe4C&lpg=PP1&dq=data%2520manipulation%2520spector&pg=PP1#v=onepage&q&f=false
