...
* Install [R, a free software environment for statistical computing and graphics][1] from [CRAN][2], the Comprehensive R Archive Network. I __highly recommend__ you install a precompiled binary distribution for your operating system -- use the links up at the top of the CRAN page linked above!
...
* Install RStudio's IDE (stands for _integrated development environment_), a powerful user interface for R. Get the Open Source Edition of RStudio Desktop.
  ...
  - I __highly recommend__ you run the [Preview version][3]. I find these quite stable and you'll get the cool new features! Update to new Preview versions often.
  - Of course, there are also official releases available [here][4].
...
* Do whatever is appropriate for your OS to launch RStudio. You should get a window similar to the screenshot you see [here][5], but yours will be more boring because you haven't written any code or made any figures yet!
...
* [How to Use RStudio][6]
* [RStudio's leads for learning R][7]
* [R FAQ][8]
* [R Installation and Administration][9]
* [More about add-on packages in the R Installation and Administration Manual][10]


[1]: https://www.r-project.org
[2]: https://cloud.r-project.org
[3]: https://www.rstudio.com/products/rstudio/download/preview/
[4]: https://www.rstudio.com/products/rstudio/#Desktop
[5]: https://www.rstudio.com/wp-content/uploads/2014/04/rstudio-workbench.png
[6]: https://support.rstudio.com/hc/en-us
[7]: https://support.rstudio.com/hc/en-us/articles/200552336-Getting-Help-with-R
[8]: https://cran.r-project.org/faqs.html
[9]: http://cran.r-project.org/doc/manuals/R-admin.html
[10]: https://cran.r-project.org/doc/manuals/R-admin.html#Add_002don-packages
